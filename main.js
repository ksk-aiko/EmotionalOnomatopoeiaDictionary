...
class EmotionObject {
    ...
    getHtmlContainerString() {
        let htmlString = 
        `
            <a href="#sec${i}" class="d-flex flex-column justify-content-center align-items-center text-center small-square col-12 col-md-3 m-3" style="background-color: ${this.color}; color:white;">
                <h3>${this.emotion}</h3>
